        ...
        <div className="max-w-4xl mx-auto">
          ...
          <div className="grid grid-cols-1 md:grid-cols-3 gap-8 max-w-2xl mx-auto">
            <div className="flex flex-col items-center gap-3">
              ...
              <span className="text-sm text-muted-foreground">Real-World Experience</span>
            </div>
            <div className="flex flex-col items-center gap-3">
              <div className="w-12 h-12 bg-card rounded-lg flex items-center justify-center shadow-card">
                <Users className="h-6 w-6 text-primary" />
              </div>
              <span className="text-sm text-muted-foreground">Collaborative Growth</span>
            </div>
            <div className="flex flex-col items-center gap-3">
              <div className="w-12 h-12 bg-card rounded-lg flex items-center justify-center shadow-card">
                <Trophy className="h-6 w-6 text-primary" />
              </div>
              <span className="text-sm text-muted-foreground">Paid Opportunities</span>
            </div>
          </div>
        </div>
      </div>
